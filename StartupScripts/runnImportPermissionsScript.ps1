# Filename: runImportPermissionsScript.ps1
# Contributors:
#   - Spring 2020:
#     -- Mario Arturo Lopez Martinez - Added comments to explain eaach line of script

# RUN THIS SCRIPT IF YOU'RE ON WINDOWS!
# If not, use the bash script.

# Build an image of our app with the name=cappy tag=latest
