              ...
              >
                <Card style={{ justifyContent: "center" }}>
                  <CardContent>
                    <br />
                    <li>
                      Sponsors benefit from mutual partnerships with{" "}
                      {university}
                    </li>
                    <br />
                    <li>
                      Sponsors see an uptick in profits via site-wide
                      advertisements
                    </li>
                    <br />
                    <li>
                      Work with and mentor students for potential recruiting
                      opportunities
                    </li>
                    <br />
                    <li>
                      Receive valuable work products as end results of student
                      projects
                    </li>
                  </CardContent>
                </Card>
            ...
            <Grid item xs={12} md={4}>
              ...
              <div align="center">
                ...
                <Dialog open={this.state.open} onClose={this.handleClose}>
                  ...
                  <DialogContent>
                    <DialogContentText>
                      If you are interested in sponsoring a future capstone,
                      please enter your contact information here. We will reach
