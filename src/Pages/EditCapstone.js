...
class EditCapstone extends Component {
  ...
  async handleEdit() {
    ...
    axios.put(
      strapiURL + "/Capstones/" + this.state.id,
      {
  ...
  checkValue(value) {
    if (value.FullName === "") {
      ...
      return (
        <Grid container>
          <Grid xs={12}>{"Username: " + value.username}</Grid>
          <Grid xs={12}> {"Full Name: " + value.FullName}</Grid>
        </Grid>
      );
    }
  }
                    ...
                    <Grid item xs={12}>
                      ...
                      <form className={classes.formMargin} noValidate>
                        <TextField
                          ...
                          variant={"outlined"}
                          className={"container"}
                          value={EditCapstone.formatDefaultDate(
                          ...
                          >
                            <ListItem key={value} button>
                              ...
                              <ListItemSecondaryAction>
                                <Checkbox
                                  defaultChecked={this.checkSponsor(value.id)}
                    ...
                    <Grid item xs={12}>
                      ...
                      <Grid xs={7}>
                        <img
                          src={
                            strapiURL +
                            this.state.capstones[0]["DisplayPhoto"].url
                          }
...
export default compose(withStyles(styles), withWidth())(EditCapstone);
