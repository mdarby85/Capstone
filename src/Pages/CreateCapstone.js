...
class CreateCapstone extends Component {
  ...
  isFormValid = () => {
    ...
    for (let i = 0; i < this.state.capstones.length; i++) {
      if (
        this.state.capstones[i].CapstoneName.toUpperCase() ===
        CapstoneName.toUpperCase()
      ) {
        validName = false;
        break;
      }
                      ...
                      {this.state.Users.map((value, i) => (
                        ...
                        >
                          <ListItem key={value}>
                            ...
                            <ListItemSecondaryAction>
                              <Checkbox
                                defaultChecked={this.checkUser(value.id)}
...
export default compose(withStyles(styles), withWidth())(CreateCapstone);
