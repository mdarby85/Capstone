...
class ViewPost extends React.Component {
  ...
  checkUserLoggedIn(result2) {
    ...
    if ("USER" in localStorage) {
      if (
        JSON.parse(localStorage.getItem("USER")).username === result2.username
      ) {
        var icons = (
          <IconButton
            aria-label="Delete"
            onClick={e =>
              ViewPost.handleDelete(e, result2.id, this.state.post["_id"])
            }
          >
                      ...
                      <ListSubheader>
                        <Typography variant="h4">
                          ...
                          {this.state.editable === true && (
                            <Grid
                              container
                              justify={ViewPost.alignCommentButton(this.props)}
                            >
                              <Button
                                onClick={e =>
                                  this.handleClickOpen(e, "open", e)
                                }
                                variant="outlined"
                                color="primary"
                          ...
                          <div>
                            <ListItem key={result2}>
                              <Card style={{ width: "100%" }}>
                                ...
                                <Divider />
                                <CardContent>
                                  <Typography>{result2.content}</Typography>
            ...
            >
              ...
              <DialogActions>
                <Button
                  ...
                  onClick={() => {
                    this.handleCreateComment(this.state.post["_id"], "open");
                  }}
                >
                  Submit Comment
                </Button>
...
export default compose(withStyles(styles), withWidth())(ViewPost);
