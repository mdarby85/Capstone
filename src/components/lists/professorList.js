...
import { PROFESSOR_QUERY, USER_DELETE_QUERY } from "data/queries"
...
export default () => {
  ...
  // Column field names
  const fields = ["name", "departments", "email"]
  return (
    <div>
      <StyledTable>
        <thead>{GenerateTableHeaders(["Name", "Departments", "Email"])}</thead>
        {loading && (
          <tbody>
            <tr>
        ...
        {error && (
          <tbody>
            <tr>
              <TableData>Error: ${error.message}</TableData>
            </tr>
          </tbody>
        )}
        {data && (
              ...
              <tr key={node.id}>
                ...
                <IconTd>
                  <div align="right">
                    ...
                    <Modal
                      isOpen={edit_modal[id]}
                      toggle={() => edit_modal_toggle(id)}
                    >
                      <ModalHeader toggle={() => edit_modal_toggle(id)}>
                        Edit Professor
                      </ModalHeader>
                      <ModalBody>
                        <EditUserForm
                            ...
                            >
                              ...
                              <ModalBody>
                                <h4 style={{ textAlign: "center" }}>
                                  {" "}
                                  Are you sure you want to delete {node.name}'s
                                  account?
                                </h4>
                                <hr />
                                <Button
