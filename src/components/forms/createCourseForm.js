...
export default ({ onCreateSuccess }) => {
    ...
    const [createCourse, { loading: mutationLoading, error: mutationError }] = useMutation(CREATE_COURSE, {
        onCompleted: () => {
            onCreateSuccess()
        },
    })
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} name="Create A Course Form">
                ...
                <select name="semester" ref={register({ required: "This field is required." })}>
                ...
                <input type="number" name="year" ref={register({ required: "This field is required." })} />
                {errors.year && <p>{errors.year.message}</p>}
                <br />

                <label htmlFor="startDate">Start Date</label>
                <input name="startDate" type="date" ref={register({ required: "This field is required." })} />
                {errors.startDate && <p>{errors.startDate.message}</p>}
                <br />

                <label htmlFor="endDate">End Date</label>
                <input name="endDate" type="date" ref={register({ required: "This field is required." })} />
