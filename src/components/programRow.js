        ...
        <Modal isOpen={edit_modal} toggle={edit_modal_toggle}>
          ...
          <ModalBody>
            <EditProgramForm
              progID={node.id}
              progName={node.name}
              progDescription={node.description}
              progThumbnail={node.thumbnail ? node.thumbnail.id : ""}
              ...
              <Modal isOpen={del_modal} toggle={delete_modal_toggle}>
                ...
                <ModalBody>
                  <h4 style={{ textAlign: "center" }}>
                    {" "}
                    Are you sure you want to delete the program {node.name}?
                  </h4>
                  <hr />
                  <Button
