...
class About extends React.Component {
  ...
  bubbleClickFun = label => {
    let sponsors = [];
    this.state.sponsors.map((result, i) => sponsors.push(result));
          ...
          <Grid container justify="center">
            <Grid item xs={12} md={10}>
              <Card className={classes.card}>
                <Typography
                  align="center"
                  variant={About.resizeTitleText(this.props)}
                ...
                <CardContent>
                  <Typography
                    align="center"
                    variant={About.resizeSubheadingText(this.props)}
                  >
                    <b>
                      "Our mission is to provide students a reliable place to
                      store and present their capstone projects."
                    </b>
                  </Typography>
                </CardContent>
              </Card>
                ...
                <Grid item xs={12} md={12}>
                  <Card className={this.setLeftColClass(this.props)}>
                    <CardContent>
                      ...
                      <Divider />
                      <Typography
                        variant={About.resizePostContentText(this.props)}
                        style={{ marginTop: "1%" }}
                      >
                        Cappy is a Capstone Management System designed for
                        students and sponsors alike. We provide students a
                        platform to <b>store, edit, and present</b> their
                        capstone projects. Moreover, Cappy gives our sponsors a
                        firsthand view of the projects that they have sponsored.
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
