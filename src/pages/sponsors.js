...
const BorderBottom = { borderBottom: "solid 1px #3a3a3a" }
const BorderRight = { borderRight: "solid 1px #3a3a3a" }
...
export default () => (
    <MainLayout>
        ...
        <Section1Container>
            ...
            <Section1p>
                Join our community of motivated and accomplished professionals and gain access to the same level of
                support, and networking opportunities, that our on-campus students have. Baylor is dedicated to your
                success—from day one to graduation and beyond.
            </Section1p>
        </Section1Container>
        <div>
        ...
        <QuoteContainer>
            ...
            <QuoteText>
                "Join our community of motivated and accomplished professionals and gain access to the same level of
                support, and networking opportunities, that our on-campus students have."
            </QuoteText>
