...
export default () => (
  <Layout>
      <Section1Container>
          ...
          <Section1p>Join our community of motivated and accomplished professionals and gain access to the same level of support, and networking
              opportunities, that our on-campus students have. Baylor is dedicated to your success—from day one to graduation and beyond.</Section1p>
      </Section1Container>
      <div>
      ...
      <Section2Container>
          <Row style={BorderBottom}>
              <Col style={BorderRight}>
                  <SponsorItem title={"Bringing Great Ideas to Life"} img={gIcon}
      ...
      <QuoteContainer>
          ...
          <QuoteText>"Join our community of motivated and accomplished professionals and gain access to the same level of support, and networking opportunities, that our on-campus students have." </QuoteText>
