...
export default () => (
  <Layout>
    <Row>
      ...
      <Col>
        <Section1Container>
          ...
          <Section1p>The intuitive new way to showcase College Universities' Capstone Experience. Developed by students
            for institutions everywhere.</Section1p>
        </Section1Container>
      </Col>
    </Row>
    <Section2ContainerPrimary>
      ...
      <Section2HrPrimary/>
      <Section2pPrimary>The intuitive new way to showcase College Universities' Capstone Experience. Developed by
        students for institutions everywhere. The intuitive new way to showcase College Universities' Capstone
        Experience. Developed by students for institutions everywhere.</Section2pPrimary>
    </Section2ContainerPrimary>
    <Section2ContainerSecondary>
      <Section2TitleSecondary>Background</Section2TitleSecondary>
      <Section2HrSecondary/>
      <Section2pSecondary>The intuitive new way to showcase College Universities' Capstone Experience. Developed by
        students for institutions everywhere. The intuitive new way to showcase College Universities' Capstone
        Experience. Developed by students for institutions everywhere.</Section2pSecondary>
    </Section2ContainerSecondary>
    <Section2ContainerPrimary>
    ...
    <Section4Container>
      <Row>
        ...
        <Col>
          ...
          <Section4p>The intuitive new way to showcase College Universities' Capstone Experience. Developed by
            students for institutions everywhere. The intuitive new way to showcase College Universities' Capstone
            Experience. Developed by students for institutions everywhere.</Section4p>
        </Col>
      </Row>
    </Section4Container>
  </Layout>
