    ...
    <MainLayout>
        ...
        <Section1Container className="pt-4">
            <div className="text-center">
                ...
                <Hr />
                <Section1p>
                    Our vision is to partner with companies and other external organizations to provide students
                    opportunities to experience the full process of defining problems, generating design concepts, and
                    building out solutions. The experience gained in our Capstone programs transform our students into
                    talented and equipped prospective employees and graduate candidates.
                </Section1p>
                <Row>
                    <Col>
                        <div className="text-right py-5">
                            <Button to="/programs/browse" textColor="white" solid medium>
                                Try
                            </Button>
                        </div>
                    </Col>
                    <Col>
                        <div className="text-left py-5">
                            <Button to="/programs/browse" textColor="primary-green" border medium>
                                Learn More
                            </Button>
                        </div>
                    </Col>
        ...
        <Container className="py-5">
            <Row>
                ...
                <Col>
                    <div className="text-right py-5">
                        <Button to="/projects/browse" textColor="primary-green" border medium>
                            View all
                        </Button>
                    </div>
                </Col>
