...
export default () => (
    <Layout>
        ...
        <Row>
            <Col>
                <TeamCard ImgSrc={image} Name={"Chris Holle"} Department={"Baylor Computer Science"} Role={"Full-Stack Development"}/>
            </Col>
            <Col>
                <TeamCard ImgSrc={image} Name={"Chris Holle"} Department={"Baylor Computer Science"} Role={"Full-Stack Development"}/>
            </Col>
        ...
        <Row style={{margin: '5em 0'}}>
            ...
            <Col>
                <CourseCard Name={"CSI 43C9 - Section 02"} Semester={"Spring 2020"} active={false}/>
            </Col>
            <Col>
                <CourseCard Name={"CSI 43C9 - Section 02"} Semester={"Spring 2020"} active={false}/>
            </Col>
