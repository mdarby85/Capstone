...
const AuthOptions = {
  method: "POST",
  url: process.env.GATSBY_AUTH0_TOKEN_DOMAIN,
  headers: { "content-type": "application/x-www-form-urlencoded" },
  form: {
    grant_type: "client_credentials",
    client_id: process.env.GATSBY_AUTH0_MANAGE_CLIENT_ID,
    client_secret: process.env.GATSBY_AUTH0_MANAGE_SECRET,
...
module.exports = (function() {
  ...
  function getUserByID(id) {
    request(AuthOptions, function(error, response, body) {
      ...
      var options = {
        method: "GET",
        url: `https://${process.env.GATSBY_AUTH0_DOMAIN}/api/v2/users/${id}`,
        headers: {
          Authorization: `Bearer ${obj_body.access_token}`,
  ...
  function createUser(dataString) {
    request(AuthOptions, function(error, response, body) {
      ...
      var options = {
        method: "POST",
        url: `https://${process.env.GATSBY_AUTH0_DOMAIN}/api/v2/users`,
        body: dataString,
        headers: {
          Authorization: `Bearer ${obj_body.access_token}`,
          "Content-Type": "application/json",
